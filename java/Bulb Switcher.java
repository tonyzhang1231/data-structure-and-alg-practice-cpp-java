...
// Total Accepted: 33582
// Total Submissions: 80220
// Difficulty: Medium
// Contributors: Admin
...
// 4 and 9, and double divisor 6. So bulb i ends up on if and only if i is a square.

// So just count the square numbers.

// Let R = int(sqrt(n)). 
// That's the root of the largest square in the range [1,n]. And 1 is the smallest root. 
// So you have the roots from 1 to R, that's R roots. Which correspond to the R squares. 
// So int(sqrt(n)) is the answer. 
